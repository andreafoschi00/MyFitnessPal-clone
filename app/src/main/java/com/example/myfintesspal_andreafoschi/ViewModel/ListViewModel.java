...
public class ListViewModel extends AndroidViewModel {
    ...
    public ListViewModel(@NonNull Application application) throws ParseException {
        ...
        CardItemRepository itemRepository = new CardItemRepository(application);
        ...
        cardItems = itemRepository.getCardItemList();
    }
    ...
    public LiveData<List<CardItem>> getCardItems(){ return cardItems; }
}
